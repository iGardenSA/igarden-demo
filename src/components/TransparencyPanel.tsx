...
const SIMULATED = [
  "كل القراءات الحالية في الديمو محاكاة (90% — موقع عسفان فقط يحوي بعض حسّاسات live)",
...
const NEXT = [
  "ربط FastAPI + MQTT بـ Raspberry Pi CM5 على عسفان (تحت G2 — يحتاج موافقة قبل التشغيل)",
